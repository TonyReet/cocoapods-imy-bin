    ...
    def template_hash
      {
          ...
          'code_repo_url' => { description: '源码私有源 Git 地址', default: 'git@git.chinawayltd.com:rentao02/g7_spec_dev.git' },
          'binary_repo_url' => { description: '二进制私有源 Git 地址', default: 'git@git.chinawayltd.com:rentao02/g7_spec_bin_dev.git' },
          'binary_download_url' => { description: '二进制下载地址，内部会依次传入组件名称与版本，替换字符串中的 %s ', default: 'http://172.22.111.113:8080/frameworks/%s/%s/zip' },
